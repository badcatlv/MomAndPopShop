...
namespace MomAndPopShop.Migrations
{
    ...
    [Migration("20240609162215_AddPopcornSeasoningTable")]
    partial class AddPopcornSeasoningTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PopcornSeasoning", b =>
                {
                    b.Property<int>("PopcornsId")
                        .HasColumnType("int");

                    b.Property<int>("SeasoningsId")
                        .HasColumnType("int");

                    b.HasKey("PopcornsId", "SeasoningsId");

                    b.HasIndex("SeasoningsId");

                    b.ToTable("PopcornSeasonings", (string)null);
                });
            ...
            modelBuilder.Entity("PopcornSeasoning", b =>
                {
                    b.HasOne("MomAndPopShop.Models.Popcorn", null)
                        .WithMany()
                        .HasForeignKey("PopcornsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MomAndPopShop.Models.Seasoning", null)
                        .WithMany()
                        .HasForeignKey("SeasoningsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
